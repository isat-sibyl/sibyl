...
setuptools.setup(
    ...
    packages=['sibyl'],
    package_data={'sibyl': ['components/*', 'layouts/*', 'locales/*', 'locales/.global.json', 'pages/*', 'static/*', 'sibyl-static/*', 'static/favicon/*', 'settings.yaml', 'hot-reload.html', 'Pipfile', 'requirements.txt']},
