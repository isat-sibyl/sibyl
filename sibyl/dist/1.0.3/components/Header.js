	...
	function computeActive() {
		...
		const lang = document.querySelector("locale").innerText;
		if (pages) {
			...
			if (longestLink && (longestLink == window.location.pathname || !`/${locale}/`.startsWith(longestLink))) longestLink.classList.add("active");
		}
	}
